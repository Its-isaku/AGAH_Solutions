    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('admin', 'Admin'), ('staff', 'Staff')], default='customer', help_text='User type classification', max_length=20)),
                ('is_verified', models.BooleanField(default=False, help_text='Has the user verified their email address?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('token', models.UUIDField(default=uuid.uuid4, help_text='Unique token sent in verification email', unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='When the verification token was generated')),
                ('expires_at', models.DateTimeField(help_text='When the token expires and becomes invalid')),
                ('is_used', models.BooleanField(default=False, help_text='Has this token been used to verify email?')),
                ('user', models.ForeignKey(help_text='User who needs email verification', on_delete=django.db.models.deletion.CASCADE, related_name='email_verification_tokens', to=settings.AUTH_USER_MODEL)),
            ],
            options={
